...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSNoticeList" checkbox="true" fitColumns="false" title="common.notice" actionUrl="noticeController.do?datagrid2" idField="id" fit="true" queryMode="group" sortName="createTime" sortOrder="desc">

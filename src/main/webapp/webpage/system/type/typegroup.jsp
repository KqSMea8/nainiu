...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
	...
	<input name="createDate" type="hidden" value="${typegroup.createDate}">
	<fieldset class="step">
	<div class="form">
	...
	<input name="typegroupname" class="inputxt" value="${typegroup.typegroupname }" datatype="s2-20"> <span class="Validform_checktip"><t:mutiLang langKey="common.name.range" langArg="common.name,common.range2to20"/></span></div>
	</fieldset>
</t:formvalid>
</body>
</html>

...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
	...
	<%--
	<t:dgCol title="办公室电话" field="officePhone" hidden="true"></t:dgCol>
	<t:dgCol title="出生日期" field="birth" formatter="yyyy-MM-dd"></t:dgCol>
	<t:dgCol title="参加工作时间" field="joindate" formatter="yyyy-MM-dd"></t:dgCol>
	<t:dgCol title="学历" field="education" dictionary="education"></t:dgCol>
	<t:dgCol title="身份证号码" field="idcard" ></t:dgCol>
	<t:dgCol title="转正时间" field="zhuanztime" formatter="yyyy-MM-dd"></t:dgCol>
	<t:dgCol title="入党时间" field="rdtime" formatter="yyyy-MM-dd" ></t:dgCol>
	--%>

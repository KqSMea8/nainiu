...
<div class="easyui-layout" style="width:600px;height:550px;">
    ...
    <div data-options="region:'center'">
        <t:datagrid  name="userList1" title="商品详情" actionUrl="nGoodsDetaislController.do?datagrid"
                    fit="true" fitColumns="true" idField="id" queryMode="group"   sortName="createDate" sortOrder="desc">
            <t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
            <t:dgCol title="商家名称"  field="merchantname"   query="true" queryMode="single"  width="180"></t:dgCol>

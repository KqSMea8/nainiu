			...
			<div class="row">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nGoodsDetaislController.do?auditdoUpdate" method="POST">
							...
							<div class="panel-heading" style="background-color:#f5f5f5;margin-bottom:15px;margin-top:15px;"">商品关键信息--审核信息</div>
						...
						<%--	<div class="form-group mno">
							...
							<div class="form-group mno">
								...
								<div class="col-sm-4">
								<t:dictSelect field="goodsDetaislStatus" id="goodsDetaislStatus" type="list"
								    typeGroupCode="goods_detaisl_status" defaultVal="${nGoodsDetaislPage.goodsDetaislStatus}" hasLabel="false" 
								    title="goodsDetaislStatus"  datatype="*">
								</t:dictSelect> 
								</div>
							</div>
							<div class="form-group mno">
								...
								<div class="col-sm-4" style="width:60%;" >
								<textarea placeholder="建议300字以内" id="reject" name="reject"  class="form-control" style="height:100px;" datatype="*1-300" >${nGoodsDetaislPage.reject }</textarea>
								<span class="Validform_checktip"></span>
								</div>
							</div>
							<div class="form-group mno">
			...
			$.ajax({
			  ...
			  if(location.href.indexOf("load=detail")!=-1){
				...
				//$("#formSubmit").hide();
					 ...
					 $('#goodsDetaislStatus').removeAttr("disabled");

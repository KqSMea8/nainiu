...
<html lang="en">
	...
	<head>
		...
		<script src="webpage/com/jeecg/n_goods_detaisl/commonUpload.js"></script>
		
		<link href="plug-in/ui/css/shang.css" rel="stylesheet" type="text/css">
		<script type="text/javascript">
				var pid="${pid}";
				var startshoptype="${startshoptype}";
				$(function(){
				// $("#starttype").attr("readOnly",true); //不可编辑，可以传值;
				 var  t;
				 if(startshoptype==0){
				   t+='<option value="1">助力团</option>'
					+'<option value="2">普通团</option>';
				 }else{
					 t+='<option value="2">普通团</option>';
		...
		<script src="webpage/com/jeecg/n_goods_detaisl/goods_classify.js"></script>
	</head>
			...
			<div class="row">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nGoodsDetaislController.do?doAdd" method="POST">
							...
							<div class="panel-heading" style="background-color:#f5f5f5;margin-bottom:15px;margin-top:15px;"">商品关键信息--新增商品</div>
							...
							<div class="form-group mno">
								...
								--%>
								   <select name="starttype" id="starttype" style="width:157px;"class="form-control" onchange="Javascript:starttypeChange();">
								   <%--  <option value="1">任务团</option>
										<option value="2">普通团</option>
										--%>
									</select>
								</div>
								 <c:if test="${startshoptype==0}">
									<label  class="col-sm-2 control-label" style="text-align:center;">虚拟:</label>
									<div class="col-sm-4">
										<select name="isvirtual" id="isvirtual" style="width:157px;"class="form-control"  >
										       <option value="1">否</option>
										       <option value="0">是</option>
									     </select>
									</div>
								  </c:if>	
								  <c:if test="${startshoptype==1}">
									<input id="isvirtual" name="isvirtual" type="hidden" value="1" />
								  </c:if>
							</div>
							<div class="form-group mno">
							...
							<div class="form-group mno" style="display: none" id = "returnMoneyDiv">
								...
								<div class="col-sm-4">
									<t:dictSelect field="returnMoney" type="list" id="returnMoney" typeGroupCode="returnMoney" defaultVal="${nGoodsDetaislPage.returnMoney}" hasLabel="false"
                            ...
                            <div class="form-group mno" id = "levelDiv" style="display: none">
                                ...
                                <div class="col-sm-4" style="width:80%">
                                    一级奖励&nbsp;&nbsp;:&nbsp;&nbsp;<input  type="text" id="oneLevel" name="oneLevel"  datatype="*" value="0" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp二级奖励&nbsp;&nbsp;:&nbsp;&nbsp;<input  type="text" id="twoLevel" name="twoLevel"  datatype="*" value="0" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp三级奖励&nbsp;&nbsp;:&nbsp;&nbsp;<input  type="text" id="threeLevel" name="threeLevel"  datatype="*" value="0" />
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp推荐奖金&nbsp;&nbsp;:&nbsp;&nbsp;<input  type="text" id="referralBonus" name="referralBonus"  datatype="*" value="0" />
                                </div>
                            </div>
							<div class="form-group mno">
									 ...
									 <div style=" width: 139px;height: 139px;float: left;display: inline-block;margin-right: 10%;margin-bottom: 2%;">
		         							...
		         							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
				          							<a href="javascript:filebtn('fileimgpic_one');" style="cursor: pointer; display: inline-block; width: 139px;height: 139px;">
					  							        <img id="pic_oneimg" src="plug-in/ui/images/shangchuan.png" style="width: 139px;height: 139px; overflow: hidden;" >
					  							    </a>
							...
							<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">商品活动图:
								 <input id="picTwo" name="picTwo" datatype="*" type="hidden" value="${nGoodsDetaislPage.picTwo }"></label>
							<div class="col-sm-4" style="width: 50%;">
							 <div style=" width: 139px;height: 139px;float: left;display: inline-block;margin-right: 10%;margin-bottom: 2%;">
									 <div class="hidden">
         							...
         							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
		          							<a href="javascript:filebtn('fileimgpic_two');" style="cursor: pointer; display: inline-block; width: 139px;height: 139px;">
			  							        <img id="pic_twoimg" src="plug-in/ui/images/shangchuan.png" style="width: 139px;height: 139px; overflow: hidden;" >
			  							    </a>
							...
							<div class="form-group mno" style="margin-top: 20px;">
									<label  class="col-sm-2 control-label" style="text-align:center;">商品轮播图:
										<input id="carouselOne" name="carouselOne"type="hidden" datatype="*"  value="123"></label>
							...
							<div class="form-group mno" style="margin-top: 20px;">
									<label  class="col-sm-2 control-label" style="text-align:center;">商品详情图: 
										<input id="detailsOne" name="detailsOne" datatype="*" type="hidden"  value="123">
									</label>
							...
							<div class="form-group mno" id="guigetwoinput"  style="margin-top:5px;margin-left:150px;display:none;" >
								...
								<p>SKU预览图尺寸要求宽度处于<span style="color: red;">320px</span>，高度<span style="color: red;">320px</span></p>
								</div>
                                <div class="form-group mno" style="margin-top:20px;margin-bottom:30px;">
							    <table class="table table-striped">
								<thead>
									<tr id="tabletitle">
									<th>库存增减</th><th>团购价</th><th>单买价</th><th>会员价</th><th>商家编码</th><th>SKU预览图</th><th>状态</th><th>操作</th>
									</tr>
								</thead>
								<tbody id="htmcontent">
									<tr>
									  
	          						  <td><input type="text" onchange="Javascript:getSumNumbers();"  id="nstandarddetails[0].sumNumber" name="nstandarddetails[0].sumNumber" value="0"  datatype="n" class="pdd-form-input" style="width: 75px;"></td>
	          						  <td><input type="text" id="nstandarddetails[0].tuanPrice" name="nstandarddetails[0].tuanPrice" value="0"  datatype="ns2" class="pdd-form-input" style="width: 75px;"></td>
	          						  <td><input type="text"  id="nstandarddetails[0].unitPrice" name="nstandarddetails[0].unitPrice" value="0"  datatype="ns2" class="pdd-form-input" style="width: 75px;"></td>
	          						  <td><input type="text"  id="nstandarddetails[0].memberPrice" name="nstandarddetails[0].memberPrice" value="0"  datatype="ns2" class="pdd-form-input" style="width: 75px;"></td>
          						      <td><input type="text"  id="nstandarddetails[0].goodsCode" name="nstandarddetails[0].goodsCode" value="0" datatype="*0-100" class="pdd-form-input" style="width: 75px;"></td>
          							  <td style="width:100px;">
          							    <div >
          							      <input id="nstandarddetails[0].picUrl" datatype="*" type="hidden"   name="nstandarddetails[0].picUrl" value="">
          							    <span class="Validform_checktip"></span>
          							      <input id="fileimg1" type="file" onchange="Javascript:commonChange1('30','30000','30000',1,'fileimg1','nstandarddetails[0].picUrl','pic_urlimg1','skuimgclose1');" style="display: none;">
          							    </div>
	          							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
			          							<a href="javascript:filebtn('fileimg1');" style="cursor: pointer; display: inline-block; width: 40px; height: 40px;">
				  							        <img id="pic_urlimg1" src="plug-in/ui/images/shangchuan.png" width="40" height="40">
				  							    </a>
	          							       <span  id="skuimgclose1" onclick="del_pic('skuimgclose1','pic_urlimg1','picUrl',1);" class="goods-sku-s-b-r-c-img-close"  style="display:none;" />
	          							 </div>
          							  </td>
          							 <input id="jishu" name="jishu" type="hidden" />
          							  <input id="nstandarddetails[0].shangxiatype" name="nstandarddetails[0].shangxiatype" type="hidden" value="0" />
									  <td><div  id="shangxiatypename1"> 已上架</div></td>
									  <td><div  id="shangxia1" onclick="Shangbtn('nstandarddetails[0].shangxiatype','shangxiatypename1','shangxia1');" data-text="下架" class="shang">下架</div></td>
									</tr>
								</tbody>
							    </table>
							 </div>
							 <div class="form-group mno">
								...
								<div class="col-sm-4" style="width:15%">
								<input  type="text" id="sumNumbers" name="sumNumbers" readonly class="form-control" datatype="n" value="0" />
								<span class="Validform_checktip"></span>
								</div>
							...
							<div class="form-group mno">
								...
								<input  type="text" id="setBounds" name="setBounds" class="form-control"
										readonly="readonly" datatype="n" value="1" />
								<span class="Validform_checktip"></span>
								</div>
								<%--
								<input   id="xiangou" name="xiangou" class="form-control"   value="${nGoodsDetaislPage.xiangou }" />
								--%>
								<label  class="col-sm-2 control-label" style="text-align:center;">限购次数:</label>
								<div class="col-sm-4" style="width:15%" >
								<input  type="text" id="xiangou" name="xiangou" class="form-control"  datatype="n" value="1" value="${nGoodsDetaislPage.xiangou }" />
								<span class="Validform_checktip"></span>
								</div>
							...
							<div class="form-group mno">
								<div class="col-sm-offset-1 col-sm-6">
									<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nGoodsDetaislController.do?list')">返回</button>
...
<script type="text/javascript" >
	$(function () {
		...
		var starttype = $("#starttype option:selected").val();
		if(starttype == "2"){
			$("#levelDiv").show();
		}else{
            $("#levelDiv").hide();
...
function geSpan(){
	...
	var jishulist= document.getElementsByName("jishu");
 	...
 	console.log("团购人=="+parseFloat(groupPurchase)<2);
	...
	var tuan_pricemax=0; 
        for(var i=0;i<jishulist.length;i++){
        	...
        	if(parseFloat(tuanPrice)<tuan_pricemin){
        		tuan_pricemin=parseFloat(tuanPrice);
        	}
        	if(parseFloat(tuanPrice)>tuan_pricemax){
        		tuan_pricemax=parseFloat(tuanPrice);
        	}
		}	
        ...
        for(var i=0;i<jishulist.length;i++){
        	...
        	if(parseFloat(unitPrice)<unit_pricemin){
        		unit_pricemin=parseFloat(unitPrice);
        	}
        	if(parseFloat(unitPrice)>unit_pricemax){
        		unit_pricemax=parseFloat(unitPrice);
        	}
		}
	                		 ...
	                		 for (j=0;j<array_twos.length ;j++ ) 
	                			 ...
	                			 var n=k-1;
	            				  ...
	            				  htmcontent+='<td>'+array_ones[i]+'</td>'
	            						  ...
	            						  +'<td style="width:100px;">'
	          							    +'<div >'
	            				               +'<input id="nstandarddetails['+n+'].picUrl" datatype="*" name="nstandarddetails['+n+'].picUrl" type="hidden" value="">'
	            				               +'<span class="Validform_checktip"></span>'
			 ...
			 tabletitle+='<th>库存增减</th>'
			  ...
			  htmcontent+='<tr >	'
					  ...
					  +'<td><input type="text"   id="nstandarddetails['+n+'].goodsCode" name="nstandarddetails['+n+'].goodsCode" value="0"  datatype="*0-36" class="pdd-form-input" style="width: 75px;"><span class="Validform_checktip"></span></td>'
 	            	  +'<td style="width:100px;">'
					    +'<div>'
			               +'<input id="nstandarddetails['+n+'].picUrl" datatype="*" name="nstandarddetails[0].picUrl" type="hidden" value="">'
			               +'<span class="Validform_checktip"></span>'
					       +'<input id="fileimg'+k+'" type="file" onchange="Javascript:commonChange1(\'30\',\'30000\',\'30000\','+k+',\'fileimg'+k+'\',\'nstandarddetails['+n+'].picUrl\',\'pic_urlimg'+k+'\',\'skuimgclose'+k+'\');" style="display: none;">'
					    +'</div>'
					    +'<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">'

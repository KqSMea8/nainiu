...
function checkFileChange(MaxSize,MaxWidth,MaxHeight,index,id,picurlid,picurlimg){
	  Max_Size=MaxSize;
      Max_Width=MaxWidth;
	 ...
	 var fileEl=document.getElementById(id);//显示图片的对象 
      ...
      testGeshi(fileEl);
      up_pic(index,id,picurlid,picurlimg);
...
function testMaxSize(file){
  ...
  function testWidthHeight(file){
   ...
   console.log("1==width="+width+"+width="+height);
    ...
    function up_pic(index,id,picurlid,picurlimg){
			if(tishiboolean){
				uploadpic(index,id,picurlid,picurlimg);
			}else{
				alert(tishi);
    ...
    function uploadpic(index,id,picurlid,picurlimg){

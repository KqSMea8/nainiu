				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nGoodsDetaislController.do?doUpdate" method="POST">
							...
							<div class="panel-heading" style="background-color:#f5f5f5;margin-bottom:15px;margin-top:15px;"">33333商品关键信息</div>
							...
							<div class="form-group mno">
								...
								<div class="col-sm-4" style="width: 50%;">
								 <div style=" width: 139px;height: 139px;float: left;display: inline-block;margin-right: 10%;margin-bottom: 2%;">
										 <div class="hidden">
	     							      <input id="fileimgpic_two" type="file" onchange="Javascript:standardChange('30','360','360',1,'fileimgpic_two','picTwo','pic_twoimg','pic_twoclose');" style="display: none;">
	     							    </div>
	         							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
										  ...
										  <c:if test="${not empty poVal.standardTwoname}">
	          							  ...
	          							  <td style="width:100px;">
	          							    <div class="hidden">
	          							      ...
	          							      <input id="fileimg${stuts.index+1 }" type="file" onchange="Javascript:standardChange('30','320','320',${stuts.index+1 },'fileimg${stuts.index+1 }','nstandarddetails[${stuts.index }].picUrl','pic_urlimg${stuts.index+1 }','skuimgclose${stuts.index+1 }');" style="display: none;">
	          							    </div>
		          							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
	            						  ...
	            						  +'<td style="width:100px;">'
	          							    +'<div class="hidden">'
	            				               +'<input id="nstandarddetails['+n+'].picUrl" name="nstandarddetails['+n+'].picUrl" type="hidden" value="">'
	          							       +'<input id="fileimg'+k+'" type="file" onchange="Javascript:standardChange(\'30\',\'320\',\'320\','+k+',\'fileimg'+k+'\',\'nstandarddetails['+n+'].picUrl\',\'pic_urlimg'+k+'\',\'skuimgclose'+k+'\');" style="display: none;">'
	          							    +'</div>'
	          							    +'<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">'

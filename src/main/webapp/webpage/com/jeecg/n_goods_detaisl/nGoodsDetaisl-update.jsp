...
<html lang="en">
	...
	<head>
		...
		<script type="text/javascript">
				...
				var isvirtual="${nGoodsDetaislPage.isvirtual}";
				//alert(carousel);
				...
				// $("#starttype").attr("readOnly",true); //不可编辑，可以传值;
				 ...
				 if(startshoptype==0){
				   t+='<option value="1">助力团</option>'
					...
					$("#starttype").html(t);
					if(isvirtual!=null && isvirtual!="" && isvirtual!="null"){
						//alert(isvirtual);
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nGoodsDetaislController.do?doUpdate" method="POST">
							...
							<div class="panel-heading" style="background-color:#f5f5f5;margin-bottom:15px;margin-top:15px;"">商品关键信息--编辑</div>
										 ...
										 <c:if test="${not empty poVal.standardOnename}">
										  ...
										  <c:if test="${not empty poVal.standardTwoname}">
	          							  ...
	          							  <td style="width:100px;">
	          							    <div >
	          							      <input id="nstandarddetails[${stuts.index }].picUrl" datatype="*" name="nstandarddetails[${stuts.index }].picUrl" type="hidden"  value="${poVal.picUrl }" >
	          							      <span class="Validform_checktip"></span>
	          							      <input id="fileimg${stuts.index+1 }" type="file" onchange="Javascript:commonChange1('30','3000','30000',${stuts.index+1 },'fileimg${stuts.index+1 }','nstandarddetails[${stuts.index }].picUrl','pic_urlimg${stuts.index+1 }','skuimgclose${stuts.index+1 }');" style="display: none;">
	          							    </div>
		          							<div class="goods-sku-s-b-r-c-img" style="display: inline-block;">
		          							       ...
		          							       <span  id="skuimgclose${stuts.index+1 }" onclick="del_pic('skuimgclose${stuts.index+1 }','pic_urlimg${stuts.index+1 }','nstandarddetails[${stuts.index }].picUrl',${stuts.index+1 });" class="goods-sku-s-b-r-c-img-close"  style="display:none;" />
		          							 </div>
	          							  </td>
    ...
    $(function () {
        ...
        $("#isMember").change(function(){
            ...
            if(options == "1"){//普通商品
                ...
                var options3 = document.getElementById('returnMoney').children;

...
<div class="easyui-layout" style="width:600px;height:550px;">
    ...
    <div data-options="region:'center'">
        <t:datagrid  name="userList1" title="商品详情" actionUrl="nGoodsDetaislController.do?datagrid&joinHuodong=0&goodsDetaislStatus=2&merchantId=${merchantId}" fit="true" fitColumns="true" idField="id" queryMode="group"  checkbox="true" sortName="createDate" sortOrder="desc">
            ...
            <t:dgCol title="会员价范围"  field="memberprices"    queryMode="single"  width="60"></t:dgCol>

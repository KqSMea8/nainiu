...
<html>
	...
	<head>
		...
		<script src = "webpage/com/jeecg/n_red_packet/pt_nRedPacketList.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">订单管理-红包发放详情列表</div>
						<div class="panel-body">
						<div id="legend">
							<legend class="le">
							<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nOrderController.do?ptlist_exit&#39;)">返回上一页</button>
							</legend>
						</div>

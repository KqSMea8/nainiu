			     ...
			     //     +'<td>'+aftersaleStatusname+'</td>'
					...
					//  +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
			            +'<a href="javascript:doUrl(&#39;nOrderController.do?goptDetails&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
			             ...
			             ;
	             if(paystatus==0){
	            	 htmcontent+='<a href="javascript:delDataT(&#39;nOrderController.do?ptdoAftersale&amp;type=3&amp;id='+obj.id+'&#39;)">平台同意退款</a>'
	            			 ;
	             }
			htmcontent+='</td>'
			       +'</tr>';
...
function hs() {
	...
	delDataT('nOrderController.do?ptdoAftersale_list&ids='+s2);
}
...
function content(strate_page){
	var parms="configId=n_home_banner&field=id,createName,createBy,createDate,update_name,updateBy,update_date,sys_org_code,remarks,del_flag,bpm_status,"
			...
			+ "joinordertype,merchant_back,orderid";
	...
	//alert(shoptype_value+"="+t);
	  $.ajax({
    		...
    		data : {page:strate_page,rows:10,sort:'userId',
			          order:'desc', 
			          id:id,
	...
	console.log("dd="+date_list);
	 ...
	 var htmcontent='';
		for ( var i = 0;i<date_list.length;i++) {
            ...
            var joinordertype=is_null(obj.joinordertype);
			var orderStatusname="";
		...
		/*	var marketingOnename="";
            ...
            var joinordertypeName = "";
            if(joinordertype == "0"){
                joinordertypeName = "开团";
            }else if(joinordertype == "1"){
                joinordertypeName = "参团";
            }else{
                joinordertypeName = "充值";
            }
			...
			htmcontent+='<tr >	'
				      ...
				      +'<td>'+is_null(obj.orderid)+'</td>'
				      +'<td>'+joinordertypeName+'</td>'
			       //   +'<td>'+aftersaleStatusname+'</td>'
			        ...
			        //  +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑</a>'
					 // +'<a href="javascript:delDataT(&#39;nOrderController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
			          ...
			          +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdateputong&amp;load=detail&amp;hoad=detail&amp;id='+obj.id+'&#39;)">详情</a>'
			          +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdatepintuan&amp;load=detail&amp;hoad=detail&amp;id='+obj.id+'&#39;)">拼团详情</a>'
			          ;
			          if(orderStatus!="0" && orderStatus!="1"){
			        	  htmcontent+='<a href="javascript:doUrl(&#39;nOrderController.do?goUpdateputong&amp;load=detail&amp;doad=detail&amp;id='+obj.id+'&#39;)">添加快递</a>'
			        			  +'<a href="javascript:doSearch(&#39;kuaidiController.do?doSearch&#39;,&#39;'+obj.expressName+'&#39;,&#39;'+obj.expressNub+'&#39;)">快递查询</a>'
			        			  ;
			          }
			          htmcontent+='</td>'
			       +'</tr>';

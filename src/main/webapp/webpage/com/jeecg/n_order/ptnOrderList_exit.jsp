...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js?skin=metrole"></script>
		 <script src = "webpage/com/jeecg/n_order/ptnOrderList_exit.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">订单管理-平台退款</div>
						<div class="panel-body">
							...
							<div class="clearfix"></div>
							<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">是否虚拟</label>
									<div class="col-sm-8">
										<t:dictSelect field="isvirtual" id="isvirtual" type="list"
										    typeGroupCode="isvirtual" defaultVal="" hasLabel="false" 
										    title="isvirtual"  datatype="*">
										</t:dictSelect> 
								    </div>
							</div>
							...
							<div class="form-group col-sm-3">
								...
								<div align="right">
								<span> 
								<input class="btn btn-primary" name="delall" value="批量发红包所选" type="button" onclick="rehs()">

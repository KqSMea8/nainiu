				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nOrderController.do?doDetails" method="POST">
							...
							<div class="panel-heading" style="background-color: #f5f5f5;margin-bottom:15px;margin-top:15px;">订单一</div>
							...
							<div class="panel-heading" style="background-color: #f5f5f5;margin-bottom:15px;margin-top:15px;">订单二</div>
							
							<div class="form-group mno">
								<label  class="col-sm-2 control-label" style="text-align:center;">订单号:</label>
								<div class="col-sm-4">
									<input  type="text" id="c_id" name="c_id" class="form-control" value="${c_nOrderPage.id }" />
									<span class="Validform_checktip"></span>
								</div>
								<label  class="col-sm-2 control-label" style="text-align:center;">用户名称</label>
								<div class="col-sm-4">
								<input  type="text" id="c_realname" name="c_realname" class="form-control" value="${c_nOrderPage.realname }" />
								<span class="Validform_checktip"></span>
								</div>
							...
							<label  class="col-sm-2 control-label" style="text-align:center;">订单状态</label>
							<div class="col-sm-4">
								<t:dictSelect field="c_orderStatus" id="c_orderStatus" type="list"
								    typeGroupCode="orderStatus" defaultVal="${c_nOrderPage.orderStatus}" hasLabel="false" 
								    title="orderStatus"  >
								</t:dictSelect> 
							</div>
								<label  class="col-sm-2 control-label" style="text-align:center;">售后状态</label>
								<div class="col-sm-4">
									<t:dictSelect field="c_aftersaleStatus" id="c_aftersaleStatus" type="list"
									    typeGroupCode="aftersaleStatus" defaultVal="${c_nOrderPage.aftersaleStatus}" hasLabel="false" 
									    title="aftersaleStatus"  >
									</t:dictSelect> 
								</div>
							</div>
							<div class="panel-heading" style="background-color: #f5f5f5;margin-bottom:15px;margin-top:15px;">收货信息</div>
							<div class="form-group mno">
							...
							<div class="form-group mno">
								<div class="col-sm-offset-1 col-sm-6">
									<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nOrderController.do?listrenwu')">返回</button>

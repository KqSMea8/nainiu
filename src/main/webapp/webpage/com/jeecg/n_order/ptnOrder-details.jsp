					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nOrderController.do?doDetails" method="POST">
							...
							<div class="form-group mno">
								...
								<c:if test="${nOrderPage.isvirtual eq '0'}">
									<label  class="col-sm-2 control-label" style="text-align:center;">充值手机号</label>
									<div class="col-sm-4">
										<input  type="text" id="aftersalePhone" name="aftersalePhone" class="form-control" value="${nOrderPage.aftersalePhone }" />
										<span class="Validform_checktip"></span>
									</div>
								</c:if>
							</div>

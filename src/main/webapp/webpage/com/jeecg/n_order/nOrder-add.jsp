		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nOrderController.do?doAdd" method="POST">
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4">
								<t:dictSelect field="orderStatus" type="list"
								    typeGroupCode="orderStatus" defaultVal="${nMerchantPage.orderStatus}" hasLabel="false" 
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4">
								<t:dictSelect field="aftersaleStatus" type="list"
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="expressName" name="expressName" class="form-control" datatype="*1-100" value="${nOrderPage.expressName}" />
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							...
							<span class="Validform_checktip"></span>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nOrderController.do?list')">返回</button>

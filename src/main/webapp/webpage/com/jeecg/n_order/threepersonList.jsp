...
<html>
	...
	<head>
		...
		var orderid="${orderid}";
		 ...
		 <script src = "webpage/com/jeecg/n_order/threepersonList.js"></script>	
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="legend">
								...
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nOrderController.do?getAddWinners&amp;id=${id}&#39;)">增加中奖人</button></legend>
							</div>

...
function content(strate_page){
	var parms="configId=n_home_banner&field=id,createName,createBy,createDate,update_name,updateBy,update_date,sys_org_code,remarks,del_flag,bpm_status,"
			...
			+ "details,merchant_back,isvirtual,gameState,redResultCode,totalAmount";
	...
	if(goodsDetaislType==null || goodsDetaislType==""){
		goodsDetaislType='1';
	}
			...
			htmcontent+='<tr >	'
			     ...
			     //     +'<td>'+aftersaleStatusname+'</td>'
					...
					//  +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
			            ...
			            +'<a href="javascript:doUrl(&#39;nRedPacketController.do?ptlist&amp;id='+obj.id+'&#39;)">红包详情</a>'
			       +'</tr>';
          }
...
function hs() {
	...
	delDataT('nOrderController.do?pt_exit_money&ids='+s2,'确认退款吗?'); 
}
function rehs() {
	var s = document.getElementsByName("checkAll[]");
	var s2 = "";

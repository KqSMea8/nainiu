...
function content(strate_page){
	...
	//alert(shoptype_value+"="+t);
	  $.ajax({
    		...
    		type : 'POST',
    		datatype:"json",
    		url : 'nOrderController.do?threedatagrid&'+parms,// 请求的action路径
...
//			          +'<td>'+is_null(obj.numbers)+'</td>'
			          +'<td>'+is_null(obj.ptnumbs)+'</td>'
			        
			          +'<td>'+is_time(obj.pdtime)+'</td>'
			          +'<td class="last">'
			        //  +'<a href="javascript:doUrl(&#39;nOrderController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑</a>'
					 // +'<a href="javascript:delDataT(&#39;nOrderController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
			          ...
			          +'<a href="javascript:doUrl(&#39;nOrderController.do?Threepersonlist&amp;load=detail&amp;merchantid='+merchantid+'&amp;orderid='+obj.orderid+'&amp;id='+obj.id+'&#39;)">拼团详情</a>'
			          /*;
			          if(orderStatus!="0" && orderStatus!="1"){
			        	  htmcontent+='<a href="javascript:doUrl(&#39;nOrderController.do?goUpdate&amp;load=detail&amp;doad=detail&amp;id='+obj.id+'&#39;)">添加快递</a>'

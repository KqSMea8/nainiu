...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js?skin=metrole"></script>
		 <script src = "webpage/com/jeecg/n_order/nOrderListrenwu.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">助力团订单管理</div>
...
function ExportXlsOrder() {
	...
	var url="nOrderController.do?exportXls&merchantId=${merchantid}&orderType=0&goodsname="+goodsname+"&orderStatus="
			+orderStatus+"&goodsDetaislType=1&marketingOne="+marketingOne+"&starttime="+starttime+"&endtime="+endtime;

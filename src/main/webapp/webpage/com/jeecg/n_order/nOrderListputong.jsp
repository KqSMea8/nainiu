...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js?skin=metrole"></script>
		 <script src = "webpage/com/jeecg/n_order/nOrderListputong.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">普通团订单管理</div>
						<div class="panel-body">
							...
							<div class="form-group col-sm-3">
								...
								<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">导出状态</label>
									<div class="col-sm-8">
										<select id="selectType" name="selectType">
											<option value="two">双</option>
											<option value="one">单</option>
										</select>
									</div>
								</div>
<!--
...
-->
							...
							<div id="legend">
								<legend class="le">
								<button type="button" class="btn btn-primary" onclick="ExportXlsOrder()">批量导出订单--普通团</button>&nbsp;&nbsp;
								<button type="button" class="btn btn-primary" onclick="ImportXls()">红包批量发放</button>
								</legend>
							</div>
...
<script type="text/javascript">
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'nOrderImportxlsController.do?upload', "userList");
	}
	...
	function ExportXlsOrder() {
		...
		var url="nOrderController.do?exportXls&merchantId=${merchantid}&orderType=0&goodsname="+goodsname+"&orderStatus="+orderStatus+"&goodsDetaislType="+goodsDetaislType+"&marketingOne="+marketingOne+"&id="+id+"&starttime="+starttime+"&endtime="+endtime+"&selectType="+selectType;
    ...
    //红包批量发放
    function ImportXls() {
        openuploadwin('Excel导入', 'nOrderImportxlsController.do?upload&type=redPackage', "nOrderImportxlsList");
    }
</script>
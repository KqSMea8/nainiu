...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="newverisonController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="flg" name="flg" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="versioncode" name="versioncode" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="versionname" name="versionname" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="downloadurl" name="downloadurl" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<%--
				<tr><td colspan="2"><div class="ui_buttons">
				<input type="button" value="确定" id="formSubmit" class="ui_state_highlight" onclick="sub()">
				<input type="button" value="关闭"></div></td></tr>
				 --%>
				<tr>
				  <td colspan="2">
		...
		<%--
			...
			<input id="234btnSubmit" type="submit" value="保 存">&nbsp;

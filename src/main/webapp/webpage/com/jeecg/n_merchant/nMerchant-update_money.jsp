			...
			<div class="row">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" id="dailogForm" action="nMerchantController.do?doUpdate" method="POST">
							...
							<div class="form-group mno">
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<a id="merchantlogodelete" href="javascript:del_pic('merchantlogoUrl','merchantlogowu','merchantlogodelete','merchantlogo','merchantlogoimg')" >删除</a>
								<input id="merchantlogo" name="merchantlogo" type="hidden" value="${nMerchantPage.merchantlogo}"> </a>
								</br>
							...
							<div class="form-group mno">
								...
								<div class="col-sm-4">
								<input  type="text" id="phone" name="phone" class="form-control" readonly   datatype="m" value="${nMerchantPage.phone }" />
								<span class="Validform_checktip"></span>
								</div>
							...
							<div class="form-group mno">
									...
									<div class="col-sm-4">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a id="cardZUrldelete" href="javascript:del_pic('cardZUrlUrl','cardZUrlwu','cardZUrldelete','cardZUrl','cardZUrlimg')" >删除</a>
										<input id="cardZUrl" name="cardZUrl" type="hidden" value="${nMerchantPage.cardZUrl}" datatype="*"> </a>
										<span class="Validform_checktip"></span>
										</br>
										<a href="javascript:;" style="padding: 4px 10px;line-height: 20px;position: relative;cursor: pointer; color: #454343;border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: inline-block;">
											选择文件
									...
									<div class="col-sm-4">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a id="cardFUrldelete" href="javascript:del_pic('cardFUrlUrl','cardFUrlwu','cardFUrldelete','cardFUrl','cardFUrlimg')" >删除</a>
										<input id="cardFUrl" name="cardFUrl" type="hidden" value="${nMerchantPage.cardFUrl}" datatype="*"> </a>
										<span class="Validform_checktip"></span>
										</br>
										<a href="javascript:;" style="padding: 4px 10px;line-height: 20px;position: relative;cursor: pointer; color: #454343;border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: inline-block;">
											选择文件
							...
							<div class="form-group mno">
								<label  class="col-sm-2 control-label" style="text-align:center;">手持身份证半身照:</label>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a id="cardBUrldelete" href="javascript:del_pic('cardBUrlUrl','cardBUrlwu','cardBUrldelete','cardBUrl','cardBUrlimg')" >删除</a>
									<input id="cardBUrl" name="cardBUrl" type="hidden" value="${nMerchantPage.cardBUrl}" datatype="*"> </a>
									<span class="Validform_checktip"></span>
									</br>
									<a href="javascript:;" style="padding: 4px 10px;line-height: 20px;position: relative;cursor: pointer; color: #454343;border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: inline-block;">
										选择文件
							...
							<div class="form-group mno">
								<label  class="col-sm-2 control-label" style="text-align:center;">营业执照:</label>
									<div class="col-sm-4">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a id="orgUrldelete" href="javascript:del_pic('orgUrlUrl','orgUrlwu','orgUrldelete','orgUrl','orgUrlimg')" >删除</a>
										<input id="orgUrl" name="orgUrl" type="hidden" value="${nMerchantPage.orgUrl}"> </a>
										</br>
										<a href="javascript:;" style="padding: 4px 10px;line-height: 20px;position: relative;cursor: pointer; color: #454343;border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: inline-block;">
											选择文件
									...
									<div class="col-sm-4">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a id="bankUrldelete" href="javascript:del_pic('bankUrlUrl','bankUrlwu','bankUrldelete','bankUrl','bankUrlimg')" >删除</a>
										<input id="bankUrl" name="bankUrl" type="hidden" value="${nMerchantPage.bankUrl}"> </a>
										</br>
										<a href="javascript:;" style="padding: 4px 10px;line-height: 20px;position: relative;cursor: pointer; color: #454343;border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: inline-block;">
											选择文件
							...
							<div class="form-group mno">
								<div class="col-sm-offset-1 col-sm-6">
									<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nMerchantController.do?list_money')">返回</button>

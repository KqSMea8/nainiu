...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="webpage/com/jeecg/n_merchant/nMerchantList.js"></script>
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMerchantController.do?goAdd&#39;)">新增</button></legend>
							</div>

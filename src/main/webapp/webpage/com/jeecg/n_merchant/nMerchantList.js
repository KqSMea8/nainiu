...
function content(strate_page){
	var parms="&configId=n_merchant&field=id,create_name,create_by,update_name,update_by,update_date,sys_org_code,remarks,delFlag,bpm_status,company,shoptype,joinname,email,phone,card,urgencyName,urgencyPhone,startshoptype,shifou,cardZUrl,cardFUrl,cardBUrl,bossPhone,bossEmail,org,orgUrl,bankUrl,ispay,accountType,pid,role,actionMoney,freezeMoney,accountStatus,auditType,createDate,depositMoney,";

		...
		if(priceStatu=="0"){
			...
			htmcontent+='<tr >	'
					 ...
					 // +'<td>'+priceStatu+'</td>'
			          ...
			          +'<td class="last">'
			          +'<a href="javascript:doUrl(&#39;nMarketingFiveController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑</a>'
					 // +'<a href="javascript:delData(&#39;nMarketingFiveController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingFiveController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingFiveDetailsController.do?list&amp;id='+obj.id+'&#39;)">查看活动商品</a>'
					  +'</td>'
			       +'</tr>';
          }

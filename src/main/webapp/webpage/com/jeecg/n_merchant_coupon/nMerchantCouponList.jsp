...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_merchant_coupon/nMerchantCouponList.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">商家优惠劵</div>
						<div class="panel-body">
							<div class="search">
								
								<div class="form-group col-sm-3">
										<label  class="control-label col-sm-3 line34">优惠劵名称</label>
										<div class="col-sm-8">
										   <input type="text" name="couponName" id="couponName" value="" class="form-control">
									    </div>
								</div>
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMerchantCouponController.do?goAdd&#39;)">新增</button></legend>
							</div>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nCallcenteController.do?doAdd" method="POST">
					...
					<input id="callstatus" name="callstatus" type="hidden" value="0">
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							   <input  type="text" id="password" name="password" class="form-control" datatype="*6-40" value="${nCallcentePage.password }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">

...
<html>
	...
	<head>
		...
		<script src = "webpage/com/jeecg/n_callcente/nCallcenteList.js"></script>	
						...
						<div class="panel-body">
							<div class="search">
								<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">账号</label>
									<div class="col-sm-8">
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nCallcenteController.do?goAdd&#39;)">新增</button></legend>
							</div>

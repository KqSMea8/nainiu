...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_evaluate/nEvaluateList.js"></script>	
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="search">
								...
								<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">状态</label>
									<div class="col-sm-8">
										<select name="evaluateStatus" id="evaluateStatus" class="form-control">
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nEvaluateController.do?goAdd&#39;)">新增</button></legend>
							</div>

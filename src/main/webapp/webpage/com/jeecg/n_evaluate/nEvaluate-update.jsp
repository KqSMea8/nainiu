	...
	<div class="container bs-docs-container" style="width:100%;">
		<div class="row">
			<div class="panel panel-default">
				<div class="panel-heading">评论编辑</div>
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nEvaluateController.do?doUpdate" method="POST">
						...
						<input id="evaluateStatus" name="evaluateStatus" type="hidden" value="${nEvaluatePage.evaluateStatus }" />
						<div class="form-group mno">
							...
							<input  type="text" id="title" name="title" readonly="readonly"
									onclick="openUserSelect()" class="form-control" datatype="*" value="${nEvaluatePage.title }" />
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<textarea placeholder="建议300字以内" id="remarks" name="remarks"  class="form-control" style="height:100px;" datatype="*1-300" >${nEvaluatePage.remarks }</textarea>
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">

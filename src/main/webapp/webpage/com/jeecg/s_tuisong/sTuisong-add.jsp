...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="sTuisongController.do?doAdd" >
		...
		<input id="tsstatus" name="tsstatus" type="hidden" value="1"/>
		<input id="qtstatus" name="qtstatus" type="hidden" value="1"/>

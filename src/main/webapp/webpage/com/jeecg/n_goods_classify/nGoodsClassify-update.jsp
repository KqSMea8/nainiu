...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nGoodsClassifyController.do?doUpdate" >
					...
					<input id="delFlag" name="delFlag" type="hidden" value="${nGoodsClassifyPage.delFlag }">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="departname" name="departname" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${nGoodsClassifyPage.departname}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="description" name="description" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${nGoodsClassifyPage.description}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deposit" name="deposit" type="text" style="width: 150px" class="inputxt"   datatype="n" 
						     	 ignore="checked" 
						     	 value='${nGoodsClassifyPage.deposit}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">详情</label>
						</td>
					</tr>
					<tr>
						...
						<td class="value">
							...
							value='${nGoodsClassifyPage.parentdepartid}'
					...
					<tr>
						...
						<td class="value">
							...
							<input id="picurl" name="picurl" type="hidden" value="${nGoodsClassifyPage.picurl}"> </a>
							</br>

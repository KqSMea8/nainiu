		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMarketingTwoController.do?doUpdate" method="POST">
						<input id="id" name="id" type="hidden" value="${nMarketingTwoPage.id }" />
						<input id="createName" name="createName" type="hidden" value="${nMarketingTwoPage.createName }" />
						<input id="createBy" name="createBy" type="hidden" value="${nMarketingTwoPage.createBy }" />
						<input id="updateName" name="updateName" type="hidden" value="${nMarketingTwoPage.updateName }" />
						<input id="updateBy" name="updateBy" type="hidden" value="${nMarketingTwoPage.updateBy }" />
						<input id="updateDate" name="updateDate" type="hidden" value="${nMarketingTwoPage.updateDate }" />
						<input id="sysOrgCode" name="sysOrgCode" type="hidden" value="${nMarketingTwoPage.sysOrgCode }" />
						<input id="remarks" name="remarks" type="hidden" value="${nMarketingTwoPage.remarks }" />
						<input id="delFlag" name="delFlag" type="hidden" value="${nMarketingTwoPage.delFlag }" />
						<input id="bpmStatus" name="bpmStatus" type="hidden" value="${nMarketingTwoPage.bpmStatus }" />
						<input id="createDate" name="createDate" type="hidden" value="${nMarketingTwoPage.createDate }" />
						<input id="aduitnumb" name="aduitnumb" type="hidden" value="${nMarketingTwoPage.aduitnumb }" />
						<input id="joinnumb" name="joinnumb" type="hidden" value="${nMarketingTwoPage.joinnumb }" />
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">活动名称:</label>
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="title" name="title" class="form-control" datatype="*1-100" value="${nMarketingTwoPage.title }" />
						...
						<div class="form-group mno" >
							...
							<div id="pricetype" style="display: none;">
								...
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="${nMarketingTwoPage.price }" />
									<span class="Validform_checktip"></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group mno">
						    ...
						    <div class="col-sm-4" style="width:195px;margin-bottom: 20px;">
						      <input type="text"   value='${nMarketingTwoPage.startTime}' name="startTime" id="startTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						    <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center;">结束时间:</label>
						    <div class="col-sm-4"  style="width:195px;margin-bottom: 20px;">
						      <input type="text"  value='${nMarketingTwoPage.endTime}' name="endTime" id="endTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >排列顺序:</label>
							<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
								<input  type="text" id="orders" name="orders" class="form-control" datatype="n" value="${nMarketingTwoPage.orders }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<textarea placeholder="建议300字以内" id="details" name="details"  class="form-control" style="height:100px;" datatype="*1-300" >${nMarketingTwoPage.details }</textarea>
							<span class="Validform_checktip"></span>
							</div>
						</div>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nMarketingTwoController.do?list')">返回</button>
...
$(function(){
	/*var priceStatu="${nMarketingTwoPage.priceStatu }";

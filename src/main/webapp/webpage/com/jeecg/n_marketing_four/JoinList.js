...
//					  +'<td>'+priceStatu+'</td>'
			       ...
			       //   +'<a href="javascript:doUrl(&#39;nMarketingOneController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑</a>'
					 // +'<a href="javascript:delData(&#39;nMarketingOneController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingFourController.do?joingoUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  ;
					  if(ispay=="0"){
						  htmcontent+='<a href="javascript:doUrl(&#39;nMarketingFourDetailsController.do?joinlist&amp;id='+obj.id+'&#39;)">申请活动商品</a>'
					    ;
			           }
			      htmcontent+='</td>'
			       +'</tr>';

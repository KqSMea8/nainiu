...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nMarketingMemberDetailsController.do?doUpdate" >
					<input id="id" name="id" type="hidden" value="${nMarketingMemberDetailsPage.id }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.createName}'>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.createBy}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${nMarketingMemberDetailsPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.updateName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.updateBy}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${nMarketingMemberDetailsPage.updateDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.sysOrgCode}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.remarks}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.delFlag}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.bpmStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.merchantid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.goodsid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.audittype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.goodsname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.unitprices}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.shoptype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.tuanprices}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.merchantname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingMemberDetailsPage.oneid}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/jeecg/n_marketing_member_details/nMarketingMemberDetails.js"></script>

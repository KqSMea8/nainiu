	...
	<head>
		...
		<script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js?skin=metrole"></script>
		 ...
		 var oneid="${oneid}";
		 	...
		 	<script src = "webpage/com/jeecg/n_marketing_member_details/JoinDetailsList.js"></script>
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="legend">
								<legend class="le">
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMarketingMemberController.do?joinlist&#39;)">返回活动</button>
								<!--
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMarketingFiveDetailsController.do?goAdd&oneid=${oneid}&merchantid=${merchantid}&#39;)">新增</button>
								-->
...
function openUserSelect() {
		...
		$.dialog({content: 'url:nGoodsDetaislController.do?selectlist', zIndex: getzIndex(), title: '会员活动商品添加',
			...
			if(rowsData.length>0){
			  ...
			  $('#'+numbid).val(node.id+"="+node.title);	 */
				...
				$.ajax({
			  		...
			  		type : 'POST',
			  		datatype:"json",
			  		url : 'nMarketingMemberDetailsController.do?dooneAdd',// 请求的action路径

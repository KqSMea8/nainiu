...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nMarketingTwoDetailsController.do?doUpdate" >
					<input id="id" name="id" type="hidden" value="${nMarketingTwoDetailsPage.id }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.createName}'>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.createBy}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${nMarketingTwoDetailsPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.updateName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.updateBy}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${nMarketingTwoDetailsPage.updateDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.sysOrgCode}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.remarks}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.delFlag}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.bpmStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.merchantid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.goodsid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.audittype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.goodsname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.unitprices}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.shoptype}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.tuanprices}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.merchantname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${nMarketingTwoDetailsPage.oneid}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/jeecg/n_marketing_two_details/nMarketingTwoDetails.js"></script>		

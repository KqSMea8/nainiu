		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMerchantAccountController.do?doUpdate" method="POST">
						...
						<div class="form-group mno">
							...
							<input  type="text" id="merchantname" name="merchantname" class="form-control" datatype="*1-500" value="${nMerchantAccountPage.merchantname}" />
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="goodsname" name="goodsname" class="form-control" datatype="*1-500" value="${nMerchantAccountPage.goodsname }" />
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
						...
						<div class="col-sm-4" style="width:60%;" >
						  <input type="text" value='${nMerchantAccountPage.unfreezeTime}' name="unfreezeTime" id="unfreezeTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4">
							<t:dictSelect field="accountStatusType" type="list"
							    typeGroupCode="accountStatusType" defaultVal="${nMerchantAccountPage.accountStatusType}" hasLabel="false" 
							    title="accountStatusType"  datatype="*">
							</t:dictSelect> 
							</div>
							<label  class="col-sm-2 control-label" style="text-align:center;">账号金额类型:</label>
							<div class="col-sm-4">
							<t:dictSelect field="priceStatusType" type="list"
							    typeGroupCode="priceStatusType" defaultVal="${nMerchantAccountPage.priceStatusType}" hasLabel="false" 
						...
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >金额:</label>
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="${nMerchantAccountPage.price }" />
									<span class="Validform_checktip"></span>
								</div>
								<label  class="col-sm-2 control-label" style="text-align:center;" >关联单号:</label>
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="ordercode" name="ordercode" class="form-control" datatype="*" value="${nMerchantAccountPage.ordercode }" />
									<span class="Validform_checktip"></span>
								</div>
						</div>

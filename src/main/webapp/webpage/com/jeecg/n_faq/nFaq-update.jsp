...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nFaqController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
					    	...
					    	<textarea name="details" id="details" style="width: 650px;height:300px">${nFaqPage.details}</textarea>
						    <script type="text/javascript">

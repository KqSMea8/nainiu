...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="false" usePlugin="password" layout="table" action="jh1Controller.do?doUpdate" tiptype="1" callback="callback">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" 
									ignore="ignore"
									class="inputxt"  value='${jh1Page.title}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="duantitle" name="duantitle" type="text" style="width: 150px" 
									ignore="ignore"
									class="inputxt"  value='${jh1Page.duantitle}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deta" name="deta" type="text" style="width: 150px" 
									ignore="ignore"
									class="inputxt"  value='${jh1Page.deta}'>
							<span class="Validform_checktip"></span>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nExpressMoneyController.do?doAdd" method="POST">
	 ...
	 var checkboxValue= new Array();  
	    ...
	    for(var i=0; i<checkboxStr.length; i++){  
	     if(checkboxStr[i].checked){  
	           ...
	           checkboxText.push($.trim(checkboxStr[i].nextSibling.nodeValue)); 
	      }  
	     }   
	     //输出值和文本  

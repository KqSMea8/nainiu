...
<html>
	...
	<head>
		...
		var merchantid="${merchantId}";
		 ...
		 <script src = "webpage/com/jeecg/n_express_money/nExpressMoneyList.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">快递包邮模板</div>
						<div class="panel-body">
							<div class="search">
								
								<div class="form-group col-sm-3">
										<label  class="control-label col-sm-3 line34">地区名称</label>
										<div class="col-sm-8">
										   <input type="text" name="areaname" id="areaname" value="" class="form-control">
									    </div>
								</div>
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nExpressMoneyController.do?goAdd&#39;)">新增</button></legend>
							</div>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nCouponController.do?doUpdate" method="POST">
						...
						<input id="delFlag" name="delFlag" type="hidden" value="${nCouponPage.delFlag }" />

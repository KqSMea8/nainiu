...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ceController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
									  <input id="joinTime" name="joinTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*" 
									  ignore="checked"
									    value='<fmt:formatDate value='${cePage.joinTime}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  ...
									  ignore="ignore"
									    value='<fmt:formatDate value='${cePage.timeT}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							    	...
							    	<textarea name="content" id="content" style="width: 650px;height:300px"  value='${cePage.content}'>${cePage.content}</textarea>
								    <script type="text/javascript">

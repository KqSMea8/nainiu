			...
			htmcontent+='<tr >	'
					...
					//  +'<td>'+priceStatu+'</td>'
					 ...
					 // +'<a href="javascript:delData(&#39;nMarketingOneController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingOneController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingOneDetailsController.do?list&amp;id='+obj.id+'&#39;)">查看活动商品</a>'
					  +'</td>'
			       +'</tr>';
          }

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMarketingThreeController.do?doAdd" method="POST">
						...
						<input id="aduitnumb" name="aduitnumb" type="hidden" value="0" />
						<input id="joinnumb" name="joinnumb" type="hidden" value="0" />
						...
						<div class="form-group mno" >
							...
							<div id="pricetype" style="display: none;">
								...
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="0" />
									<span class="Validform_checktip"></span>
								</div>
							</div>
						</div>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMarketingThreeController.do?doUpdate" method="POST">
						<input id="id" name="id" type="hidden" value="${nMarketingThreePage.id }" />
						<input id="createName" name="createName" type="hidden" value="${nMarketingThreePage.createName }" />
						<input id="createBy" name="createBy" type="hidden" value="${nMarketingThreePage.createBy }" />
						<input id="updateName" name="updateName" type="hidden" value="${nMarketingThreePage.updateName }" />
						<input id="updateBy" name="updateBy" type="hidden" value="${nMarketingThreePage.updateBy }" />
						<input id="updateDate" name="updateDate" type="hidden" value="${nMarketingThreePage.updateDate }" />
						<input id="sysOrgCode" name="sysOrgCode" type="hidden" value="${nMarketingThreePage.sysOrgCode }" />
						<input id="remarks" name="remarks" type="hidden" value="${nMarketingThreePage.remarks }" />
						<input id="delFlag" name="delFlag" type="hidden" value="${nMarketingThreePage.delFlag }" />
						<input id="bpmStatus" name="bpmStatus" type="hidden" value="${nMarketingThreePage.bpmStatus }" />
						<input id="createDate" name="createDate" type="hidden" value="${nMarketingThreePage.createDate }" />
						<input id="aduitnumb" name="aduitnumb" type="hidden" value="${nMarketingThreePage.aduitnumb }" />
						<input id="joinnumb" name="joinnumb" type="hidden" value="${nMarketingThreePage.joinnumb }" />
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">活动名称:</label>
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="title" name="title" class="form-control" datatype="*1-100" value="${nMarketingThreePage.title }" />
						...
						<div class="form-group mno" >
							...
							<div id="pricetype" style="display: none;">
								...
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="${nMarketingThreePage.price }" />
									<span class="Validform_checktip"></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group mno">
						    ...
						    <div class="col-sm-4" style="width:195px;margin-bottom: 20px;">
						      <input type="text"   value='${nMarketingThreePage.startTime}' name="startTime" id="startTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						    <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center;">结束时间:</label>
						    <div class="col-sm-4"  style="width:195px;margin-bottom: 20px;">
						      <input type="text"  value='${nMarketingThreePage.endTime}' name="endTime" id="endTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >排列顺序:</label>
							<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
								<input  type="text" id="orders" name="orders" class="form-control" datatype="n" value="${nMarketingThreePage.orders }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<textarea placeholder="建议300字以内" id="details" name="details"  class="form-control" style="height:100px;" datatype="*1-300" >${nMarketingThreePage.details }</textarea>
							<span class="Validform_checktip"></span>
							</div>
						</div>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nMarketingThreeController.do?list')">返回</button>
...
$(function(){
/*	var priceStatu="${nMarketingThreePage.priceStatu }";

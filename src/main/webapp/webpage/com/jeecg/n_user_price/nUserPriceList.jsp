...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_user_price/nUserPriceList.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">用户钱包流水</div>
						<div class="panel-body">
							<div class="search">
								...
								<div class="form-group col-sm-3">
										...
										<div class="col-sm-8">
											<select name="userPriceType" id="userPriceType" class="form-control">

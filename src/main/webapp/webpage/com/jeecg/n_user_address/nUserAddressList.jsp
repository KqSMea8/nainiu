...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_user_address/nUserAddressList.js"></script>	
						...
						<div class="panel-body">
							<div class="search">
								...
								<div class="form-group col-sm-3">
										<label  class="control-label col-sm-3 line34">收件人</label>
										<div class="col-sm-8">
										   <input type="text" name="acceptname" id="acceptname" value="" class="form-control">
									    </div>
								</div>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMarketingHomeController.do?doUpdate" method="POST">
						<input id="id" name="id" type="hidden" value="${nMarketingHomePage.id }" />
						<input id="createName" name="createName" type="hidden" value="${nMarketingHomePage.createName }" />
						<input id="createBy" name="createBy" type="hidden" value="${nMarketingHomePage.createBy }" />
						<input id="updateName" name="updateName" type="hidden" value="${nMarketingHomePage.updateName }" />
						<input id="updateBy" name="updateBy" type="hidden" value="${nMarketingHomePage.updateBy }" />
						<input id="updateDate" name="updateDate" type="hidden" value="${nMarketingHomePage.updateDate }" />
						<input id="sysOrgCode" name="sysOrgCode" type="hidden" value="${nMarketingHomePage.sysOrgCode }" />
						<input id="remarks" name="remarks" type="hidden" value="${nMarketingHomePage.remarks }" />
						<input id="delFlag" name="delFlag" type="hidden" value="${nMarketingHomePage.delFlag }" />
						<input id="bpmStatus" name="bpmStatus" type="hidden" value="${nMarketingHomePage.bpmStatus }" />
						<input id="createDate" name="createDate" type="hidden" value="${nMarketingHomePage.createDate }" />
						<input id="aduitnumb" name="aduitnumb" type="hidden" value="${nMarketingHomePage.aduitnumb }" />
						<input id="joinnumb" name="joinnumb" type="hidden" value="${nMarketingHomePage.joinnumb }" />
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">活动名称:</label>
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="title" name="title" class="form-control" datatype="*1-100" value="${nMarketingHomePage.title }" />
						...
						<div class="form-group mno" >
							...
							<div id="pricetype" style="display: none;">
								...
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="${nMarketingHomePage.price }" />
									<span class="Validform_checktip"></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group mno">
						    ...
						    <div class="col-sm-4" style="width:195px;margin-bottom: 20px;">
						      <input type="text"   value='${nMarketingHomePage.startTime}' name="startTime" id="startTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						    <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:center;">结束时间:</label>
						    <div class="col-sm-4"  style="width:195px;margin-bottom: 20px;">
						      <input type="text"  value='${nMarketingHomePage.endTime}' name="endTime" id="endTime" class="form-control" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" datatype="*" style="background: url('plug-in/ui/images/datetime.png') no-repeat scroll right center transparent;"/>
						    </div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >排列顺序:</label>
							<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
								<input  type="text" id="orders" name="orders" class="form-control" datatype="n" value="${nMarketingHomePage.orders }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							<textarea placeholder="建议300字以内" id="details" name="details"  class="form-control" style="height:100px;" datatype="*1-300" >${nMarketingHomePage.details }</textarea>
							<span class="Validform_checktip"></span>
							</div>
						</div>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nMarketingHomeController.do?list')">返回</button>
...
$(function(){
/*	var priceStatu="${nMarketingHomePage.priceStatu }";

		...
		//	alert(dictionaryarray);
			...
			htmcontent+='<tr >	'
					 ...
					 // +'<a href="javascript:delData(&#39;nMarketingHomeController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingHomeController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingHomeDetailsController.do?list&amp;id='+obj.id+'&#39;)">查看活动商品</a>'
					  +'</td>'
			       +'</tr>';
          }

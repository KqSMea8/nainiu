...
function content(strate_page){
	...
	//alert(shoptype_value+"="+t);
	  $.ajax({
    		...
    		type : 'POST',
    		datatype:"json",
    		url : 'nMarketingHomeController.do?datagrid&'+parms,// 请求的action路径
		...
		if(priceStatu=="0"){
			...
			htmcontent+='<tr >	'
			        ...
			        //  +'<td>'+is_time(obj.createDate)+'</td>'
			          ...
			          +'<td class="last">'
			       //   +'<a href="javascript:doUrl(&#39;nMarketingHomeController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑</a>'
					 // +'<a href="javascript:delData(&#39;nMarketingHomeController.do?doDel&amp;id='+obj.id+'&#39;)">删除</a>'
					  +'<a href="javascript:doUrl(&#39;nMarketingHomeController.do?joingoUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">活动详情</a>'
					  ;
					  if(ispay=="0"){
						  htmcontent+='<a href="javascript:doUrl(&#39;nMarketingHomeDetailsController.do?joinlist&amp;id='+obj.id+'&#39;)">申请活动商品</a>'
					  ;
			        }
			      htmcontent+='</td>'
			       +'</tr>';

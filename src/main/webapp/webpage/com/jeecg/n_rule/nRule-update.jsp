...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nRuleController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							    	...
							    	<textarea name="details" id="details" style="width: 650px;height:300px">${nRulePage.details}</textarea>
								    <script type="text/javascript">

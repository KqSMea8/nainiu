	...
	console.log("dd="+date_list);
	 ...
	 var htmcontent='';
		for ( var i = 0;i<date_list.length;i++) {
			...
			if(freezeType==0){
			htmcontent+='<a href="javascript:delDataT(&#39;nMerchantFreezeController.do?doDel&amp;id='+obj.id+'&#39;)">解冻</a>';
			}
		   htmcontent+='<a href="javascript:doUrl(&#39;nMerchantFreezeController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  +'</td>'
			       +'</tr>';
          }

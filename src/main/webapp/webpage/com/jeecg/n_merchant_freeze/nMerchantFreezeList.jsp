...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_merchant_freeze/nMerchantFreezeList.js"></script>	
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<legend class="le">
							<button type="button" class="btn btn-primary" onclick="history.go(-1)">返回上一页</button>
							</legend>
						</div>

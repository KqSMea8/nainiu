...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_merchant_freeze/nMerchantFreezeList_merchant.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">冻结商家金额</div>
						<div class="panel-body">
							<div class="search">
							
								<div class="form-group col-sm-3">
										<label  class="control-label col-sm-3 line34">冻结状态</label>
										<div class="col-sm-8">
										<t:dictSelect field="freezeType" id="freezeType" type="list"
										    typeGroupCode="freezeType" defaultVal="" hasLabel="false" 
							...
							<div id="legend">
								...
								<legend class="le">
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMerchantController.do?list_money&#39;)">返回上一页</button>
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMerchantFreezeController.do?goAdd&amp;merchantid=${merchantid}&#39;)">新增</button>

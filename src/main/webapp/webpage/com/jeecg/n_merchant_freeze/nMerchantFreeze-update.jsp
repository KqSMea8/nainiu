		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nMerchantFreezeController.do?doUpdate" method="POST">
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
							  <t:dictSelect field="merchantid" id="merchantid"  type="list"
								...
								title="merchantid" 
										defaultVal="${nMerchantFreezePage.merchantid}" >
							  </t:dictSelect> 
						...
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >金额:</label>
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="price" name="price" class="form-control" datatype="n" value="${nMerchantFreezePage.price }" />
									<span class="Validform_checktip"></span>
								</div>
						...
						<div class="col-sm-4" style="width:60%;" >
						<textarea placeholder="建议200字以内" id="details" name="details"  class="form-control" style="height:100px;" datatype="*1-300" >${nMerchantFreezePage.details }</textarea>
						<span class="Validform_checktip"></span>
						</div>
					</div>

		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nFeebackController.do?doUpdate" method="POST">
					...
					<input id="bpmStatus" name="bpmStatus" type="hidden" value="${nFeebackPage.bpmStatus }">
						...
						<div class="form-group mno">
							...
							<div class="col-sm-4" style="width:60%;" >
								   <input  type="text" id="realname" name="realname" class="form-control" value="${nFeebackPage.realname }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>

						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">联系电话:</label>
							<div class="col-sm-4" style="width:60%;" >
								   <input  type="text" id="phone" name="phone" class="form-control" value="${nFeebackPage.phone }" />
								<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >反馈图片:</label>
							<div class="col-sm-4" id="piclist"style="width:90%;margin-bottom: 20px;" >
								<input id="pic" name="pic" type="hidden"  value="${nFeebackPage.pic }">
								<img  style="width: 109px;height: 109px; overflow: hidden;" id="picimg"
								src="">
							</div>
						</div>
					...
					<div class="form-group mno">
						<label  class="col-sm-2 control-label" style="text-align:center;">反馈内容:</label>
						<div class="col-sm-4" style="width:60%;" >
						<textarea placeholder="建议300字以内" id="contents" name="details" 
						class="form-control" style="height:100px;" >${nFeebackPage.details}
						 </textarea>
							<span class="Validform_checktip"></span>
						</div>
					</div>		
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nFeebackController.do?list')">返回</button>
...
$(function(){
	   ...
	   var caselPic_t="${nFeebackPage.pic }";
	   var caselPic_str=caselPic_t.split(",");
	  var  caselPic_html="";
	   for (i=0;i<caselPic_str.length ;i++ ) 
		  { 
		   caselPic_html+='<input id="pic" name="pic" type="hidden" '
				   +'value="'+caselPic_str[i]+'">'
				   +'<img onclick="window.open(\''+caselPic_str[i]+'\')" '
				   +'style="width: 109px;height: 109px; overflow: hidden;" id="picimg"'
				   +'src="'+caselPic_str[i]+'">';
		  }
	 
	   $("#piclist").html(caselPic_html);
})
</script> 

...
<html>
	...
	<head>
		...
		<script src = "webpage/com/jeecg/n_phone_code/nPhoneCodeList.js"></script>		
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">手机验证码</div>
						<div class="panel-body">
							<div class="search">
								<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">手机号</label>
									<div class="col-sm-8">

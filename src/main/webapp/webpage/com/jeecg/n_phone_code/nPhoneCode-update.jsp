		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nPhoneCodeController.do?doUpdate" method="POST">
						...
						<div class="form-group mno">
							...
							<input  type="text" id="phone" name="phone" class="form-control" datatype="*m" value="${nPhoneCodePage.phone}" />
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">验证码:</label>
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="code" name="code" class="form-control" datatype="*1-36" value="${nPhoneCodePage.code }" />
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
						<label  class="col-sm-2 control-label" style="text-align:center;">内容:</label>
						<div class="col-sm-4" style="width:60%;" >
						<textarea placeholder="建议300字以内" id="details" name="details"  class="form-control" style="height:100px;" datatype="*1-300" >${nPhoneCodePage.details }</textarea>
						<span class="Validform_checktip"></span>
						</div>
						</div>
						...
						<div class="form-group mno">
							...
							<label  class="col-sm-2 control-label" style="text-align:center;">类型:</label>
							<div class="col-sm-4">
							<t:dictSelect field="phoneType" type="list"
							    typeGroupCode="phoneType" defaultVal="${nPhoneCodePage.phoneType}" hasLabel="false" 
							    title="phoneType"  datatype="*">
							</t:dictSelect> 
							</div>
						</div>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nPhoneCodeController.do?list')">返回</button>

...
<html>
	...
	<head>
		...
		<script src = "webpage/com/jeecg/n_websocket_colum/homenWebsocketColumList.js"></script>		
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">聊天目录</div>
						<div class="panel-body">
							<div class="search">
								<div class="form-group col-sm-3">
									<label  class="control-label col-sm-3 line34">客户名称</label>
									<div class="col-sm-8">
										<input type="text" name="sendname" id="sendname" value="" class="form-control">
									</div>
								</div>
							...
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;loginController.do?hplushome&#39;)">返回上一页</button></legend>
							</div>

...
<html>
	...
	<head>
		...
		<script type="text/javascript" src="plug-in/lhgDialog/lhgdialog.min.js?skin=metrole"></script>
		 ...
		 <script src = "webpage/com/jeecg/n_marketing_five_details/nMarketingFiveDetailsList.js"></script>	
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="legend">
								<legend class="le">
								<button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMarketingFiveController.do?list&#39;)">返回活动</button>
								</legend>
							</div>

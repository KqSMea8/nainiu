...
<script src="webpage/com/jeecg/n_home_banner/fileupload.js"></script>
</head>
		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="nHomeBannerController.do?doUpdate" method="POST">
						<input id="id" name="id" type="hidden" value="${nHomeBannerPage.id }" />
						<input id="createName" name="createName" type="hidden" value="${nHomeBannerPage.createName }" />
						<input id="createBy" name="createBy" type="hidden" value="${nHomeBannerPage.createBy }" />
						<input id="updateName" name="updateName" type="hidden" value="${nHomeBannerPage.updateName }" />
						<input id="updateBy" name="updateBy" type="hidden" value="${nHomeBannerPage.updateBy }" />
						<input id="updateDate" name="updateDate" type="hidden" value="${nHomeBannerPage.updateDate }" />
						<input id="sysOrgCode" name="sysOrgCode" type="hidden" value="${nHomeBannerPage.sysOrgCode }" />
						<input id="remarks" name="remarks" type="hidden" value="${nHomeBannerPage.remarks }" />
						<input id="delFlag" name="delFlag" type="hidden" value="${nHomeBannerPage.delFlag }" />
						<input id="bpmStatus" name="bpmStatus" type="hidden" value="${nHomeBannerPage.bpmStatus }" />
						<input id="createDate" name="createDate" type="hidden" value="${nHomeBannerPage.createDate }" />
						
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;">图片名称:</label>
							<div class="col-sm-4" style="width:60%;" >
							<input  type="text" id="title" name="title" class="form-control" datatype="*1-100" value="${nHomeBannerPage.title }" />
							<span class="Validform_checktip"></span>
							</div>
						</div>
						<div class="form-group mno">
							<label  class="col-sm-2 control-label" style="text-align:center;" >顺序:</label>
								<div class="col-sm-4" style="width:195px;margin-bottom: 20px;" >
									<input  type="text" id="orders" name="orders" class="form-control" datatype="n" value="${nHomeBannerPage.orders }" />
									<span class="Validform_checktip"></span>
								</div>
						</div>
	                   <div class="form-group mno">
								...
								<div class="col-sm-4">
									...
									<input id="picurl" name="picurl" type="hidden" value="${nHomeBannerPage.picurl }"> </a>
									</br>
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('nHomeBannerController.do?list')">返回</button>

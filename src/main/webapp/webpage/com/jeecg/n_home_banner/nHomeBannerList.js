...
//	var goods_detaisl_status=document.getElementById("goods_detaisl_status").value;
	...
	//alert(shoptype_value+"="+t);
	  $.ajax({
    		...
    		type : 'POST',
    		datatype:"json",
    		url : 'nHomeBannerController.do?datagrid&'+parms,// 请求的action路径
	 ...
	 var htmcontent='';
		...
		//	var ce=is_null(obj.ce);
			...
			htmcontent+='<tr >	'
			          ...
			          +'<td class="last">'
			          +'<a href="javascript:doUrl(&#39;nHomeBannerController.do?goUpdate&amp;id='+obj.id+'&#39;)">编辑&nbsp;&nbsp;</a>'
					  +'<a href="javascript:delDataT(&#39;nHomeBannerController.do?doDel&amp;id='+obj.id+'&#39;)">删除&nbsp;&nbsp;</a>'
					  +'<a href="javascript:doUrl(&#39;nHomeBannerController.do?goUpdate&amp;load=detail&amp;id='+obj.id+'&#39;)">详情</a>'
					  +'</td>'
			       +'</tr>';
          }

var Max_Size = 30; //2M
var Max_Width = 3000; //100px
var Max_Height = 3000; //200px
var tishi='';
    ...
    if(file.files && file.files[0]){
        ...
        reader.onload = function (e) {
            ...
            image.onload=function(){
                ...
                isAllow = parseInt(width) >= parseInt(100)&& parseInt(width) <= parseInt(960)
                    && parseInt(height) >= parseInt(100)&& parseInt(height) <= parseInt(960);
...
function up_pic(id,yulanurl,yulanurlwu,yulanurldelete,picurlid,picurlimg){
    //alert(tishi+"="+tishiboolean);
    //	console.log(tishi+"="+tishiboolean+"="+tishiwhboolean);

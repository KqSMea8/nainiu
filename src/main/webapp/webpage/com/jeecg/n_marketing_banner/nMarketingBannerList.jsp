...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="plug-in/ui/css/layer.css" id="layui_layer_skinlayercss">
		 <script src = "webpage/com/jeecg/n_marketing_banner/nMarketingBannerList.js"></script>	
			...
			<div class="row">
				...
				<div class="col-md-10" style="width:100%">
					<div class="panel panel-default">
						<div class="panel-heading">活动图片</div>
						<div class="panel-body">
							<div class="search">
							
							</div>
							<div id="legend">
								<legend class="le"><button type="button" class="btn btn-primary" onclick="doUrl(&#39;nMarketingBannerController.do?goAdd&#39;)">新增</button></legend>
							</div>

package com.jeecg.n_faq.service.impl;
...
@Service("nFaqService")
@Transactional
public class NFaqServiceImpl extends CommonServiceImpl implements NFaqServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NFaqEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NFaqEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NFaqEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NFaqEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NFaqEntity t){

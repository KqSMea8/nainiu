package com.jeecg.newverison.entity;
 ...
 * @date 2017-08-26 10:59:12
 * @version V1.0   
 *
 */
@Entity
@Table(name = "newverison", schema = "")
@SuppressWarnings("serial")
public class NewverisonEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="FLG",nullable=true,length=100)
	 ...
	 */
	@Column(name ="VERSIONCODE",nullable=true,length=100)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  版面名称
	 */
	@Column(name ="VERSIONNAME",nullable=true,length=100)
	 ...
	 */
	@Column(name ="DOWNLOADURL",nullable=true,length=1000)

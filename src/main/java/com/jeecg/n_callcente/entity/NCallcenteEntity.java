package com.jeecg.n_callcente.entity;
 ...
 */
@Entity
@Table(name = "n_callcente", schema = "")
@SuppressWarnings("serial")
public class NCallcenteEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="CALLSTATUS",nullable=true,length=32)

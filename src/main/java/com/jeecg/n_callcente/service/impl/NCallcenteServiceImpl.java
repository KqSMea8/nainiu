package com.jeecg.n_callcente.service.impl;
...
@Service("nCallcenteService")
@Transactional
public class NCallcenteServiceImpl extends CommonServiceImpl implements NCallcenteServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NCallcenteEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NCallcenteEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NCallcenteEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NCallcenteEntity t){
		...
		map.put("callstatus", t.getCallstatus());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NCallcenteEntity t){
 		...
 		sql  = sql.replace("#{callstatus}",String.valueOf(t.getCallstatus()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("n_callcente",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

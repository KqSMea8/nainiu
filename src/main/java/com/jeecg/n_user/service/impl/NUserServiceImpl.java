package com.jeecg.n_user.service.impl;
...
@Transactional
public class NUserServiceImpl extends CommonServiceImpl implements NUserServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NUserEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NUserEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NUserEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NUserEntity t){
		...
		map.put("addresscode", t.getAddresscode());
		map.put("birth", t.getBirth());
		map.put("details", t.getDetails());
		map.put("usernameurl", t.getUsernameurl());
		map.put("cid", t.getCid());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NUserEntity t){
 		...
 		sql  = sql.replace("#{addresscode}",String.valueOf(t.getAddresscode()));

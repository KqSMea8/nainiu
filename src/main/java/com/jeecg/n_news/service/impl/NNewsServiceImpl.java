package com.jeecg.n_news.service.impl;
...
@Service("nNewsService")
@Transactional
public class NNewsServiceImpl extends CommonServiceImpl implements NNewsServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NNewsEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NNewsEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NNewsEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NNewsEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NNewsEntity t){
 		...
 		sql  = sql.replace("#{numbs}",String.valueOf(t.getNumbs()));

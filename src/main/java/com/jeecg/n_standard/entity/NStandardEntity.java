package com.jeecg.n_standard.entity;
 ...
 */
@Entity
@Table(name = "n_standard", schema = "")
@SuppressWarnings("serial")
public class NStandardEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  规格类型
	 */
	@Column(name ="STANDARD_TYPE",nullable=true,length=50)

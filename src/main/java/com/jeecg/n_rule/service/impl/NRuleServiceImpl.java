package com.jeecg.n_rule.service.impl;
...
@Service("nRuleService")
@Transactional
public class NRuleServiceImpl extends CommonServiceImpl implements NRuleServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NRuleEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NRuleEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NRuleEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NRuleEntity t){
		...
		map.put("rule_type", t.getRuleType());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NRuleEntity t){

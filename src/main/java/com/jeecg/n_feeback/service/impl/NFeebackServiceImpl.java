package com.jeecg.n_feeback.service.impl;
...
@Service("nFeebackService")
@Transactional
public class NFeebackServiceImpl extends CommonServiceImpl implements NFeebackServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NFeebackEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NFeebackEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NFeebackEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NFeebackEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NFeebackEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("n_feeback",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

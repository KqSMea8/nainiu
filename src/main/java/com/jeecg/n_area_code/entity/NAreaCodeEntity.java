package com.jeecg.n_area_code.entity;
 ...
 */
@Entity
@Table(name = "n_area_code", schema = "")
@SuppressWarnings("serial")
public class NAreaCodeEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="AREAID",nullable=true,length=100)

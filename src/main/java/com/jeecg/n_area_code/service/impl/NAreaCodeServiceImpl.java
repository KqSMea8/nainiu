package com.jeecg.n_area_code.service.impl;
...
@Service("nAreaCodeService")
@Transactional
public class NAreaCodeServiceImpl extends CommonServiceImpl implements NAreaCodeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NAreaCodeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NAreaCodeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NAreaCodeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NAreaCodeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NAreaCodeEntity t){
 		...
 		sql  = sql.replace("#{areaid}",String.valueOf(t.getAreaid()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("n_area_code",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

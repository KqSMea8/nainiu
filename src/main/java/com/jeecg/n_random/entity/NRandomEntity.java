package com.jeecg.n_random.entity;
 ...
 */
@Entity
@Table(name = "n_random", schema = "")
@SuppressWarnings("serial")
public class NRandomEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  关联对应表的id
	 */
	@Column(name ="PKID",nullable=true,length=50)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  关联对应表的id
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  随机生成
	 */
	@Column(name ="RANDOM",nullable=true,length=50)

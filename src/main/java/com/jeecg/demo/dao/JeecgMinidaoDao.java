...
public interface JeecgMinidaoDao {
	...
	@Arguments("pid")
 	@Sql("select id,parentdepartid as pid,departname as name  from n_goods_classify  where  parentdepartid=:pid order by org_code asc ")
    List<Map<String, String>> getGoods(String pid);

package com.jeecg.weixin_log.service.impl;
...
@Transactional
public class WeixinLogServiceImpl extends CommonServiceImpl implements WeixinLogServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WeixinLogEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(WeixinLogEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(WeixinLogEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(WeixinLogEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinLogEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("weixin_log",data);
				}
			} catch (Exception e) {
				e.printStackTrace();

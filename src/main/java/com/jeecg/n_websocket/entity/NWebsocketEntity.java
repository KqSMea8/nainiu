package com.jeecg.n_websocket.entity;
 ...
 */
@Entity
@Table(name = "n_websocket", schema = "")
@SuppressWarnings("serial")
public class NWebsocketEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="usernameurl",nullable=true)
	...
	@Column(name ="merchantlogo",nullable=true)
	...
	@Column(name ="merchantname",nullable=true)

package com.jeecg.n_user_price.service.impl;
...
@Service("nUserPriceService")
@Transactional
public class NUserPriceServiceImpl extends CommonServiceImpl implements NUserPriceServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(NUserPriceEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(NUserPriceEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(NUserPriceEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(NUserPriceEntity t){
		...
		map.put("user_price_type", t.getUserPriceType());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NUserPriceEntity t){
 		...
 		sql  = sql.replace("#{user_price_type}",String.valueOf(t.getUserPriceType()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("n_user_price",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
